...
public class ScoreBoard extends JFrame implements ActionListener {
	...
	//update GUI lab 4 : init RUN GA button
	private JButton runGaB = new JButton ("Run GA");
	
	public ScoreBoard(minimax.Game game2) {
		this.game = game2;
		setSize(350, 200);
		setResizable(true);
	...
	//Action listener for the all buttons
	public void actionPerformed(ActionEvent e) {
		...
		// call function when run GA button clicked	
		} else if (btn == runGaB){
			game.viewGA();  
		} else {
			game.help();
